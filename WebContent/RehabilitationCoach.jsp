		...
		<div class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<div>
						<ul class="nav navbar-nav">
							<li class="active">
								<a href="./RehabilitationCoach.jsp" id="gardCyclist">运动员管理</a>
							</li>
							<li>
								<a>运动员分析报告</a>
							</li>
				...
				<div class="row-fluid" id="showCyclist">
					...
					<div class="block">
						...
						<div class="block-content collapse in">
							<div class="span12">
								...
								<form  action="./insertRData" method="post" enctype="multipart/form-data">
								...
								<div class="btn-group pull-left"> 
									<!--  时间输入输出框 -->
									<form class="navbar-form navbar-right" action="./showROneDay" method="post" role="search">
										<div class="input-group">
								...
								<th onclick="$.sortTable.sort('tableSort',4)" style="cursor: pointer;">血红蛋白(g/dl)</th>
								<th onclick="$.sortTable.sort('tableSort',5)" style="cursor: pointer;">血清睾酮(nmol/L)</th>
								<th onclick="$.sortTable.sort('tableSort',6)" style="cursor: pointer;">血清肌酸激酶(U/L)</th>
								<th onclick="$.sortTable.sort('tableSort',7)" style="cursor: pointer;">精氨酸摄入量(g)</th>
								<th onclick="$.sortTable.sort('tableSort',8)" style="cursor: pointer;">酪氨酸摄入量(g)</th>
								<th onclick="$.sortTable.sort('tableSort',9)" style="cursor: pointer;">训练当天睡眠时间(h)</th>
								<th onclick="$.sortTable.sort('tableSort',10)" style="cursor: pointer;">伤痛关节冰敷时间(min)</th>
								<th onclick="$.sortTable.sort('tableSort',11)" style="cursor: pointer;">肌肉推拿康复时间(min)</th>
								<th onclick="$.sortTable.sort('tableSort',12)" style="cursor: pointer;">平均速度(Km/min)</th>
								</tr>
								</thead>
									<tbody>
										<tr >
					...
					List<Object[]> result=rTableDao.getRTable(punString);
					//System.out.println(result.size());
					if(result!=null){
					for(Object[] obj: result ){
					%>
											<td><a href="./Rehabilitationathlete.jsp?id=<%=obj[0] %>"><%=obj[0] %></a></td>
											<td ><a class="name11" href="./Rehabilitationathlete.jsp?id=<%=obj[0] %>"><%=obj[1] %></a></td>
											<td><%=obj[2] %></td>
											<td><%=obj[3] %></td>
