		...
		<div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="./RehabilitationCoach.jsp">康复学科教练</a>
                                ...
                                <div class="span12">		
									...
									<div class="btn-group pull-left">   
								      ...
								      <button type="button" class="btn btn-default" data-toggle="modal"  href="#athletegraph1" >日期-速度折线图</button>
								        &nbsp; &nbsp; &nbsp;
								      <button type="button" class="btn btn-default" data-toggle="modal"  href="#athletegraph2" >日期-血清睾酮折线图</button>
								       &nbsp; &nbsp; &nbsp;
								      <button type="button" class="btn btn-default" data-toggle="modal"  href="#athletegraph3" >日期-睡眠时间折线图</button>
									</div>
									<div id="test">
	                ...
	                <%
   	                	...
   	                	C_rDao c_rDao=new C_rDao();
   	                	List<Integer> obj=c_rDao.getRid(id);
   	                	for(int str:obj){
   	                		//System.out.println("nid是"+str);
     	                RTableDao rTableDao=new RTableDao();
     	                List<Object[]> o=rTableDao.getRTableByRid(str);
     	                if(o!=null)
     	                {
	     	                for(Object[] list:o)
	     	                {
		                %>
							  ...
							  <td ><%=list[5] %></td>	
							  <td class="energy11"><%=list[6] %></td>	
							  <td><%=list[7] %></td>	
							  <td class="salt11"><%=list[8] %></td>	
							  <td><%=list[9] %></td>	
							  <td class="suger11"><%=list[10] %></td>	
							  <td ><%=list[11] %></td>
							  <td ><%=list[12] %></td>	
							  <td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li class="divider"></li>
											<li><a href="./deleteRCyclist?rid=<%=str %>&id=<%=list[1] %>">删除</a></li>												
										</ul>
									</div></td></tr>
							   <%
	     	                	} 
