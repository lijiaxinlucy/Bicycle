						...
						<div class="span12">
							...
							<table class="table" style="margin-bottom: 80px;">
								...
								<tbody>
									<tr>
					<% 
					//url中不可以直接传递中文参数，，，需要进行编码，，只要是传非英文的地方都需要进行这样的处理
					//，，一个在设置参数的地方进行encode，另一个在取出参数的地方进行decode，js中也有相应的函数
					String realParam=URLDecoder.decode(request.getParameter("realParam"),"utf-8");
					System.out.println(realParam);
					List<Object[]> user;
					UserDao userDao=new UserDao();
					user=userDao.selectUserByUserName(realParam);
					if(user!=null){
						for(Object[] o:user){
