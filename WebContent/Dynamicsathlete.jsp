									...
									<div class="btn-group pull-left">   
						              ...
						              <tr class="info"></tr>
						                <tr>
										  ...
										  <th onclick="$.sortTable.sort('tableSort',6)" style="cursor: pointer;">PCO2</th>
										<th onclick="$.sortTable.sort('tableSort',7)" style="cursor: pointer;">PO2</th>
										<th onclick="$.sortTable.sort('tableSort',8)" style="cursor: pointer;">BE</th>
										<th onclick="$.sortTable.sort('tableSort',9)" style="cursor: pointer;">HCO3</th>
										<th onclick="$.sortTable.sort('tableSort',10)" style="cursor: pointer;">TCO2</th>
										<th onclick="$.sortTable.sort('tableSort',11)" style="cursor: pointer;">SO2</th>
										<th onclick="$.sortTable.sort('tableSort',12)" style="cursor: pointer;">K</th>
						  ...
						  <td>
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu">
													...
													<li class="divider"></li>
													<li><a href="./deleteDCyclist?did=<%=str %>&id=<%=list[1] %>">删除</a></li>												
												</ul>
											</div>	
										  </td>
						                </tr>
