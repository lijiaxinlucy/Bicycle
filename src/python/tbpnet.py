...
sql2 = "select E_ARG,E_TYR,SLEEP,ICE,MSG,weight,air,ang,high,suger,protein,fat,salt from together2"
sql1= "select speed from together2"
try:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--testdata', default="[1.2, 1.2, 8, 1.2, 1.2, 8, 10, 1.2, 1.2, 8, 10, 1.2, 1.2]", type=str)
